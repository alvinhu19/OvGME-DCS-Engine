...
{down = 3002, up = 3002, cockpit_device_id  = devices.WEAPON_SYSTEM, value_down = 1, value_up = 0.0, name = _('Weapon Release Button'), category = _('Stick')},
{down = iCommandPlaneFire, up = iCommandPlaneFireOff, 												name = _('Cannon Fire Button'), category = _('Stick')},
})
