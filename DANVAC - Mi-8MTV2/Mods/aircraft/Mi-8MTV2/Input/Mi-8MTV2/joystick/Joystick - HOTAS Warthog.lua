...
{combos = {{key = 'JOY_BTN6'}},	down = device_commands.Button_25,	up = device_commands.Button_25, cockpit_device_id = devices.SPU_7, value_down = 1.0, value_up = 0.0,	name = _('Radio trigger - RADIO'),		category = {_('Ins Cyclic Stick'), _('Communications')}},
{combos = {{key = "JOY_BTN1"}},	down = device_commands.Button_25,	up = device_commands.Button_25, cockpit_device_id = devices.SPU_7, value_down = 0.5, value_up = 0.0,	name = _('Radio trigger - ICS'),		category = {_('Ins Cyclic Stick'), _('Communications')}},

{combos = {{key = "JOY_BTN19"}},	down = iCommandPlaneTrimOn, up = iCommandPlaneTrimOff,																					name = _('Trimmer Button'),				category = {_('Ins Cyclic Stick'), _('Trimmer')}},
{combos = {{key = "JOY_BTN13"}},	down = iCommandPlaneTrimCancel,																											name = _('Trimmer - Reset'),			category = {_('Ins Cyclic Stick'), _('Trimmer')}},

{combos = {{key = "JOY_BTN4"}},	down = iCommandPlaneWheelBrakeOn,	up = iCommandPlaneWheelBrakeOff,																	name = _('Wheel Brake'),				category = {_('Ins Cyclic Stick')}},
{combos = {{key = "JOY_BTN3"}},	down = iCommandPlaneWheelParkingBrake,																									name = _('Wheel Parking Brake'),		category = {_('Ins Cyclic Stick')}},

{combos = {{key = "JOY_BTN5"}},	down = iCommandAutopilotEmergOFF,	up = iCommandAutopilotEmergOFF_up,																	name = _('Turn Off Autopilot Button'),	category = {_('Ins Cyclic Stick'), _('Autopilot')}},
...
{	down = iCommandPlaneCMDDispence,				up = iCommandPlaneCMDDispenceOff,				name = _('UV-26 Start Dispensing Button'),						category = {_('Right Auxiliary Panel'), _('Ins Countermeasures dispensers UV-26')}},
{	down = iCommandPlaneCMDDispenceStop,			up = iCommandPlaneCMDDispenceStopOff,			name = _('UV-26 Stop Dispensing Button'),						category = {_('Right Auxiliary Panel'), _('Ins Countermeasures dispensers UV-26')}},
...
-- joystick axes
{combos = {{key = "JOY_X"}, }, 	action = iCommandPlaneRoll,			name = _('Flight Control Cyclic Roll')},
{combos = {{key = "JOY_Y"}, },	action = iCommandPlanePitch,		name = _('Flight Control Cyclic Pitch')},
