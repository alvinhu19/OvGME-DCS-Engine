...
-- Wheel Brake
{combos = {
    {key = "JOY_X", filter = {curvature = {0}, deadzone = 0, invert = true, saturationX = 1, saturationY = 1, slider = false}},
    {key = "JOY_Y", filter = {curvature = {0}, deadzone = 0, invert = true, saturationX = 1, saturationY = 1, slider = false}}
