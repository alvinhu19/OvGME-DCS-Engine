...
{down = iCommandPlaneAirBrakeOn,								value_down = 1,					name = _('Airbrake Switch - OPEN'),		category = {_('Flight Control'), _('Throttle Grip')}},
{down = iCommandPlaneAirBrakeOff,							value_down = 1,					name = _('Airbrake Switch - CLOSE'),	category = {_('Flight Control'), _('Throttle Grip')}},
--
...
-- Stick
{down = 3022,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1.0,	name = _('Weapon Fire Button Safety'),	category = _('Stick Grip')},
...
-- ASP-3NMU Gunsight ---------------------------
------------------------------------------------
{combos = {{key = 'JOY_BTN5'}},	down 	= device_commands.Button_15,	cockpit_device_id = devices.ASP_3NM,	value_down = 1, 		name = _('ASP-3NMU Gunsight Mode, GYRO/FIXED'),								category = {_('ASP-3NMU Gunsight'), _('Only Front Cockpit')}},
...
{combos = {{key = 'JOY_BTN7'}},	pressed = device_commands.Button_9,		cockpit_device_id = devices.ASP_3NM,	value_pressed = 0.5,	name = _('ASP-3NMU Gunsight Target Wingspan Adjustment Dial, Increase'),	category = {_('ASP-3NMU Gunsight'), _('Only Front Cockpit')}},
{combos = {{key = 'JOY_BTN9'}},	pressed = device_commands.Button_9,		cockpit_device_id = devices.ASP_3NM, 	value_pressed = -0.5,	name = _('ASP-3NMU Gunsight Target Wingspan Adjustment Dial, Decrease'),	category = {_('ASP-3NMU Gunsight'), _('Only Front Cockpit')}},
...
{combos = {{key = 'JOY_BTN8'}},	pressed = device_commands.Button_10,	cockpit_device_id = devices.ASP_3NM, 	value_pressed = 0.7,	name = _('ASP-3NMU Gunsight Target Distance, Increase'),					category = {_('ASP-3NMU Gunsight'), _('Only Front Cockpit')}},
{combos = {{key = 'JOY_BTN10'}},	pressed = device_commands.Button_10,	cockpit_device_id = devices.ASP_3NM, 	value_pressed = -0.7,	name = _('ASP-3NMU Gunsight Target Distance, Decrease'),					category = {_('ASP-3NMU Gunsight'), _('Only Front Cockpit')}},
...
-- RT-12
{down = engine_commands.CMD_RT_12_OFF_CVR_EXT,	cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = -1.0,	name = _('RT-12 JPT Regulator Manual Disable Switch Cover - OPEN/CLOSE'),	category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
...
{down = engine_commands.CMD_RT_12_OFF_EXT,		cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = -1.0,	name = _('RT-12 JPT Regulator Manual Disable Switch - DISABLED/ENABLED'),	category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
...
{down = iCommandEngineLaunchMethod,	value_down = 0.0,																				name = _('Engine Launch Method Switch - STARTING'),			category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
{down = iCommandEngineLaunchMethod,	value_down = 0.1,																				name = _('Engine Launch Method Switch - PRESERV'),			category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
{down = iCommandEngineLaunchMethod,	value_down = 0.2,																				name = _('Engine Launch Method Switch - COLD ROTATION'),	category = {_('Engine'), _('Left Console'), _('Only Front Cockpit')}},
...
{down = electric_commands.L39C_Command_CB_WingTanks_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Wing Tanks Switch - ON/OFF'),											category = {_('Main CB Switch Panel'), _('Only Front Cockpit')}},
...
------------------------------------------------
{down = device_commands.Button_28,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('CB Armament System Power Switch - ON/OFF'),						category = _('Armament Control Panel')},
{down = device_commands.Button_28,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('CB Armament System Power Switch - OFF'),							category = _('Armament Control Panel')},
{down = device_commands.Button_28,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('CB Armament System Power Switch - ON'),							category = _('Armament Control Panel')},
{down = device_commands.Button_29,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('CB UB-16 Rocket Firing Control Circuit Power Switch - ON/OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_29,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('CB UB-16 Rocket Firing Control Circuit Power Switch - OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_29,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('CB UB-16 Rocket Firing Control Circuit Power Switch - ON'),		category = _('Armament Control Panel')},
{down = device_commands.Button_30,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('CB ASP-FKP (Gunsight and Gun Camera) Power Switch - ON/OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_30,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('CB ASP-FKP (Gunsight and Gun Camera) Power Switch - OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_30,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('CB ASP-FKP (Gunsight and Gun Camera) Power Switch - ON'),			category = _('Armament Control Panel')},
{down = device_commands.Button_31,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('CB Missile Seeker Heating Circuit Power Switch - ON/OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_31,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('CB Missile Seeker Heating Circuit Power Switch - OFF'),			category = _('Armament Control Panel')},
{down = device_commands.Button_31,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('CB Missile Seeker Heating Circuit Power Switch - ON'),			category = _('Armament Control Panel')},
{down = device_commands.Button_32,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('CB Missile Seeker Glowing Circuit Power Switch - ON/OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_32,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('CB Missile Seeker Glowing Circuit Power Switch - OFF'),			category = _('Armament Control Panel')},
{down = device_commands.Button_32,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('CB Missile Seeker Glowing Circuit Power Switch - ON'),			category = _('Armament Control Panel')},
{down = device_commands.Button_34,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Missile/Bomb Release Selector Switch - PORT(Left)/STARB-BOTH(Right for Missiles/Both)'),	category = _('Armament Control Panel')},
{down = device_commands.Button_34,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Missile/Bomb Release Selector Switch - STARB-BOTH(Right for Missiles/Both)'),				category = _('Armament Control Panel')},
{down = device_commands.Button_34,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Missile/Bomb Release Selector Switch - PORT(Left)'),										category = _('Armament Control Panel')},
{pressed = device_commands.Button_33,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_pressed = -0.5,	name = _('Missile Seeker Tone Volume Knob - CCW'),							category = _('Armament Control Panel')},
{pressed = device_commands.Button_33,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_pressed = 0.5,	name = _('Missile Seeker Tone Volume Knob - CW'),							category = _('Armament Control Panel')},
{down = device_commands.Button_37,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Jettison Switch Cover - OPEN/CLOSE'),					category = _('Armament Control Panel')},
{down = device_commands.Button_37,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Emergency Jettison Switch Cover - CLOSE'),						category = _('Armament Control Panel')},
{down = device_commands.Button_37,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Emergency Jettison Switch Cover - OPEN'),							category = _('Armament Control Panel')},
{down = device_commands.Button_38,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,		name = _('Emergency Jettison Switch - ON/OFF'),								category = _('Armament Control Panel')},
{down = device_commands.Button_38,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Emergency Jettison Switch - OFF'),								category = _('Armament Control Panel')},
{down = device_commands.Button_38,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,			name = _('Emergency Jettison Switch - ON'),									category = _('Armament Control Panel')},
...
{down = device_commands.Button_36,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Arm/Safe Bombs Emergency Jettison Switch - NEUTRAL'),				category = _('Armament Control Panel')},
{down = device_commands.Button_40,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,			name = _('Arm/Safe Bombs Emergency Jettison Switch - LIVE/BLANK'),			category = _('Armament Control Panel')},
{down = device_commands.Button_39,		cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0.1,		name = _('Rockets Firing Mode Selector Switch - AUT.'),						category = _('Armament Control Panel')},
...
{action = device_commands.Button_18,	cockpit_device_id = devices.ASP_3NM,	name = _('ASP-3NMU Glass Raise/Lower'),							category = {_('ASP-3NMU Gunsight'), _('Only Front Cockpit')}},
