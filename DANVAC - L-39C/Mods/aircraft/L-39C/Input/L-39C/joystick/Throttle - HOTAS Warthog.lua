...
-- Flaps
{combos = {{key = 'JOY_BTN22'}},	down = iCommandPlaneFlaps,	up = iCommandPlaneFlaps,		value_down = 1,	value_up = 4,	name = _('Flaps Flight Position'),		category = {_('Flight Control'), _('Left Console')}},
...
{combos = {{key = 'JOY_BTN23'}},	down = iCommandPlaneFlaps,	up = iCommandPlaneFlaps,		value_down = 3,	value_up = 6,	name = _('Flaps Landing Position'),		category = {_('Flight Control'), _('Left Console')}},
-- Air Brake
...
{	down = iCommandPlaneFire,	up = iCommandPlaneFireOff,	name = _('Weapon Fire Button'),	category = _('Stick Grip')},
...
-- start and stop
{combos = {{key = 'JOY_BTN19'}},	down = electric_commands.L39C_Command_EngineSwCover_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,			name = _('Engine Start Button Cover - OPEN/CLOSE'),			category = {_('Engine'), _('Left Console')}},
...
{combos = {{key = 'JOY_BTN32'}},	down = electric_commands.L39C_Command_EngineSw_EXT,	up = electric_commands.L39C_Command_EngineSw_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	value_up = 0.0,	name = _('Engine Start Button'),	category = {_('Engine'), _('Left Console')}},
...
{combos = {{key = 'JOY_BTN18'}},	down = electric_commands.L39C_Command_TurboSwCover_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,				name = _('Turbo Start Button Cover - OPEN/CLOSE'),			category = {_('Engine'), _('Left Console')}},
...
{combos = {{key = 'JOY_BTN31'}},	down = iCommandPlane_APU_Start,	up = iCommandPlane_APU_Start,	value_down = 1.0,	value_up = 0.0,									name = _('Turbo Start Button'),								category = {_('Engine'), _('Left Console')}},
