...
-- Elevator Trim Wheel
{combos = {{key = 'JOY_BTN_POV1_U'}},                       pressed = device_commands.Button_38, cockpit_device_id = devices.CONTROLS, value_pressed = -1.0, name = _('Input.Yak52.trim_elevator_minus'), category = _('Flight Control')},
{combos = {{key = 'JOY_BTN_POV1_D'}},                       pressed = device_commands.Button_38, cockpit_device_id = devices.CONTROLS, value_pressed = 1.0,  name = _('Input.Yak52.trim_elevator_plus'),  category = _('Flight Control')},
...
-- Warthog
-- Flaps
{combos = {{key = 'JOY_BTN22'}},                             down = device_commands.Button_17, up = device_commands.Button_17, cockpit_device_id = devices.CONTROLS, value_down = 0.0, value_up = 0.5, name = _('Landing Flaps Lever, Up (Warthog)'), category = _('Flight Control')},
{combos = {{key = 'JOY_BTN23'}},                             down = device_commands.Button_17, up = device_commands.Button_17, cockpit_device_id = devices.CONTROLS, value_down = 1.0, value_up = 0.5, name = _('Landing Flaps Lever, Down (Warthog)'),  category = _('Flight Control')},
-- Undercarriage Extension Lever
{combos = {{key = 'JOY_BTN27'}},                             down = device_commands.Button_9, up = device_commands.Button_9, cockpit_device_id = devices.CONTROLS, value_down = -1.0, value_up = 0.0, name = _('Landing Gear Lever, Retract (Warthog)'), category = _('Systems')},
{combos = {{key = 'JOY_BTN28'}},                             down = device_commands.Button_9, up = device_commands.Button_9, cockpit_device_id = devices.CONTROLS, value_down = 1.0, value_up = 0.0, name = _('Landing Gear Lever, Extend (Warthog)'),  category = _('Systems')},
...
{combos = {{key = "JOY_Z"}},                                action = device_commands.Button_18, cockpit_device_id = devices.ENGINE_CONTROLS, name = _('Input.Yak52.throttle_slider', 'Throttle (analog)'), category = _('Engine Controls')},
{combos = {{key = "JOY_RZ"}},                               action = device_commands.Button_26, cockpit_device_id = devices.ENGINE_CONTROLS, name = _('Input.Yak52.pitch_slider', 'Engine RPM (analog)'), category = _('Engine Controls')},
